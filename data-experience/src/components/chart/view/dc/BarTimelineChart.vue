...
export default {
  ...
  data() {
    ...
    return {
      ...
      interval: null,
      intervals,
      intervalsName: Object.keys(intervals).map(value => ({
        value,
  ...
  methods: {
    drawViz() {
      ...
      this.minDate = this.dateDimension.bottom(1)[0][this.dateAccessor]
      this.maxDate = this.dateDimension.top(1)[0][this.dateAccessor]
