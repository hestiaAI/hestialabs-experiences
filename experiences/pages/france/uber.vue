        ...
        <VRow>
          <VCol cols="12">
            ...
            <div class="text-center ma-3">
              <VBtn href="https://buy.stripe.com/5kA3cEcio5Jie1GdQU" color="primary" target="_blank" disabled>
      ...
      <section ref="get-your-data" class="section-wrapper">
        ...
        <VRow justify="center">
          <VCol cols="12" md="8" lg="6" align-self="center" class="text-center">
            <FileUploader platform="uber" country="france" :product-id="1" :disable="true" />
          </VCol>
        </VRow>
      </section>
